...
The overall accuracy of the model is 0.9791, and for each class the balanced accuracy is always over 0.97. After this results the validation is conducted with the validation dataset of 20 rows.
